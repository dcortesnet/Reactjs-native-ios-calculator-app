...
const CalculatorScreen = () => {
  ...
  const saveResultNumber = () => {
    if(resultNumber.endsWith('.')){
      setPreviusNumber(resultNumber.slice(0, resultNumber.length -1));
    } else {
      setPreviusNumber(resultNumber);
    }
    setResultNumber('0');
  }
  ...
  return (
    <View style={styles.calculatorScreen}>
      ...
      <View style={styles.row}>
        <ButtonCal text={'C'} color={'black'} backgroundColor={'#9B9B9B'} onPress={deleteCal}/>
        ...
        <ButtonCal text={'/'} color={'white'} backgroundColor={'#FF9427'} onPress={() => applyOperator('/')}/>
      </View>
      ...
      <View style={styles.row}>
        ...
        <ButtonCal text={'x'} color={'white'} backgroundColor={'#FF9427'} onPress={() => applyOperator('x')}/>
      </View>
